...
fun DependencyHandler.releaseImplementation(s: String) {
    add("releaseImplementation", s)
}
...
fun DependencyHandler.annotationProcessor(s: String) {
    add("annotationProcessor", s)
}
